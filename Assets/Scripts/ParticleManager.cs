...
public class ParticleManager : MonoBehaviour
{
    ...
    private void SpawnDustParticle()
    {
        ...
        dust.transform.localScale = new Vector3(0.3f, 0.3f, 0.3f);
    ...
    private Vector3 GetRandomPositionInTile(Transform tile)
    {
        ...
        return new Vector3(Random.Range(minBounds.x, maxBounds.x), maxBounds.y + 1f, Random.Range(minBounds.z, maxBounds.z));
    }
}
